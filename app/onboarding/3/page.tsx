  ...
  return (
    <div className="min-h-dvh flex flex-col bg-white">
      ...
      <div className="px-4 py-2">
        <IlustracionManitas className="w-full h-52" />
      </div>
      ...
      <div className="flex-1 px-6 pt-2 pb-8 flex flex-col">
        ...
        <div className="mb-5">
          <h2 className="font-display font-bold text-2xl text-[#1A1A2E] mb-1">Manitas</h2>
          <p className="text-[#7B7B7B] text-sm leading-relaxed">
            Ayuda a vecinos con lo que necesiten en su casa.
          </p>
        </div>
